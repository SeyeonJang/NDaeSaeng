          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => BlocProvider<MeetCubit>(
                create: (_) =>
                    MeetCubit(), // Replace with your MeetCubit instantiation.
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            "  ${(widget.team.averageBirthYear > 1000 ? 2023 - widget.team.averageBirthYear + 1 : widget.team.averageBirthYear).toStringAsFixed(1)}세",
                            style: TextStyle(
                    ...
                    SizedBox(
                      ...
                      child: Stack(
                        children: [
                          ...
                          for (int i = widget.team.teamUsers.length - 1;
                              i >= 0;
                              i--)
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: CachedProfileImage(
                                  profileUrl: widget.team.teamUsers[i]
                                      .getProfileImageUrl(),
                                  width: SizeConfig.defaultSize * 4.5,
                                  height: SizeConfig.defaultSize * 4.5,
                                ),
