                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text("  ${(2023-team.averageBirthYear+1 > 0 ? 2023-team.averageBirthYear+1 : team.averageBirthYear).toStringAsFixed(1)}세", style: TextStyle(fontSize: SizeConfig.defaultSize * 1.45),)
                    ],
                  ),
                  Container(
