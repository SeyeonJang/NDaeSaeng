...
class TutorialSlide extends StatefulWidget {
  ...
  const TutorialSlide({required this.onTutorialFinished, Key? key})
      : super(key: key);
                ...
                children: [
                  TextButton(
                      onPressed: () {
                        ...
                        AnalyticsUtil.logEvent("온보딩_스킵", properties: {
                          "페이지인덱스": _pageController.page!.round()
                        });
                      },
                      child: Text("스킵",
                          style: TextStyle(
                  ...
                  TextButton(
                      onPressed: () {
                        _pageController.nextPage(
                            duration: const Duration(milliseconds: 400),
                            curve: Curves.easeInOut);
                        AnalyticsUtil.logEvent("온보딩_다음", properties: {
                          "페이지인덱스": _pageController.page!.round()
                        });
                      },
                      child: Text("다음",
            ...
            Row(
              children: [
                Icon(
                  ...
                  size: SizeConfig.defaultSize * 4.5,
                  color: const Color(0xff7C83FD),
                ),
    ...
    return Container(
        ...
        child: ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
              ...
              padding: EdgeInsets.only(
                  left: SizeConfig.defaultSize * 0.6,
                  right: SizeConfig.defaultSize * 0.6)),
          child: Column(
