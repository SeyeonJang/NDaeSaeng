          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                    """< 엔대생 >(이하 '엔대생')은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
...
< 엔대생 >(이하 '엔대생')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
1. 홈페이지 회원가입 및 관리
...
② 제1항에 따른 권리 행사는 엔대생에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 엔대생은(는) 이에 대해 지체 없이 조치하겠습니다.
...
- 행태정보를 수집 및 처리하려는 광고 사업자 : Meta, Google, Amplitude
...
부서명 : SSH
담당자 : 장세연
연락처 : <전화번호> 010-8020-9814, <이메일> ssh.team.swm@gmail.com
...
직책 : 최고경영책임자
직급 : 최고보안책임자
연락처 : 010-8020-9814, ssh.team.swm@gmail.com
※ 개인정보 보호 담당부서로 연결됩니다.
...
- 국내대리인의 성명 : [장세연]
- 국내대리인의 주소 : [서울특별시 강남구 테헤란로 311 (역삼동) 아남타워빌딩 7층]
- 국내대리인의 전화번호 : [010-8020-9814]
