...
abstract class BlindDateTeamRepository {
  ...
  Future<Pagination<BlindDateTeam>> getTeamsMostLiked({int page, int size, int targetLocationId});
  Future<Pagination<BlindDateTeam>> getTeamsMostSeen({int page, int size, int targetLocationId});
}
